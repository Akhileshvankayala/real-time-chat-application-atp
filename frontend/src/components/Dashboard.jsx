...
export default function Dashboard() {
  ...
  const { fetchChats, activeChat, addMessage, updateMessageStatus, fetchMessages, markAllAsRead, setTyping } = useChatStore()
  ...
  }, [socket, addMessage, updateMessageStatus, fetchChats, markAllAsRead, setTyping, user])
